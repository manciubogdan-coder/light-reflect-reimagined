          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative transform hover:scale-105 transition-transform duration-500 hover:-rotate-2">
                <img 
                  src={ebookCover} 
                  alt="Manualul Eficienței Electrice - Ghid PDF"
                  className="w-full max-w-[320px] h-auto drop-shadow-2xl rounded-lg"
                />
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3" style={{ fontFamily: "'Inter', sans-serif" }}>
                MANUALUL EFICIENȚEI ELECTRICE
              </h2>
              <p className="text-lg text-slate-600" style={{ fontFamily: "'Inter', sans-serif" }}>
                Standarde de Proiectare și Execuție pentru Dezvoltatori{" "}
                <span className="font-semibold text-electric-blue">(50 pagini)</span>
              </p>
            </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-700 text-lg" style={{ fontFamily: "'Inter', sans-serif" }}>
                  <strong>Proiectare Digitală 3D</strong>
                </span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-electric-blue/10 flex items-center justify-center flex-shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-4">
              <div>
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-electric-blue/50 transition-all ${
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-4 px-6 bg-electric-blue hover:bg-electric-blue/90 text-white font-bold text-lg rounded-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
                {isSubmitting ? (
                  <>
              ...
              <p className="text-center text-slate-500 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
