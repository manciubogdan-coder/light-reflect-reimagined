...
const Contact = () => {
  ...
  return <div className="min-h-screen bg-dark-matter">
      <Nav />
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center py-24">
        ...
        <div className="relative z-10 max-w-xl w-full tech-panel shadow-xl">
          ...
          {sent ? <div className="flex flex-col items-center gap-3">
              ...
              <div className="form-group">
                ...
                <input id="nume" className="w-full px-4 py-3 bg-dark-matter/60 border border-hologram-blue text-white focus:outline-none focus:border-electric-blue transition-all rounded-md" placeholder="Nume" name="nume" value={formData.nume} onChange={handleChange} required disabled={loading} />
              </div>
              
              <div className="form-group">
                <label htmlFor="email" className="text-white mb-1 block">Email</label>
                <input id="email" type="email" placeholder="Email" name="email" value={formData.email} onChange={handleChange} required disabled={loading} className="w-full px-4 py-3 bg-dark-matter/60 border border-hologram-blue text-white focus:outline-none focus:border-electric-blue transition-all rounded-md bg-gray-950" />
              </div>
              
              <div className="form-group">
                <label htmlFor="mesaj" className="text-white mb-1 block">Mesaj</label>
                <textarea id="mesaj" className="w-full px-4 py-3 bg-dark-matter/60 border border-hologram-blue text-white focus:outline-none focus:border-electric-blue resize-none transition-all rounded-md" placeholder="Mesajul tău" name="mesaj" value={formData.mesaj} onChange={handleChange} rows={4} required disabled={loading} />
              </div>
              
              <button className="w-full electric-button font-tech text-lg tracking-wider" type="submit" disabled={loading}>
