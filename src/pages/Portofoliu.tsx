...
const stats = [{
  value: "40%",
  label: "Viteză de Execuție Crescută",
  icon: TrendingUp
}, {
  value: "0",
  label: "Întârzieri la Predare",
  icon: CheckCircle2
}, {
  value: "5 ani",
                    ...
                    <div className="glass-panel overflow-hidden hover:border-electric-blue/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(0,119,255,0.2)]">
                      ...
                      <div className="relative h-56 overflow-hidden">
                        ...
                        <div className="absolute bottom-3 left-3 right-3 flex flex-wrap gap-2">
                          {project.badges.map((badge, i) => <Badge key={i} variant="secondary" className="bg-electric-blue/90 text-white text-xs backdrop-blur-sm">
                              {badge}
                            </Badge>)}
                        </div>
                      </div>
                      ...
                      <div className="p-5">
                        ...
                        <Button variant="outline" size="sm" onClick={() => setSelectedProject(project)} className="w-full border-electric-blue/30 hover:border-electric-blue hover:bg-electric-blue/10 font-tech group/btn">
          ...
          <div className="container mx-auto px-4">
            ...
            duration: 0.6
              ...
              <div className="relative z-10 p-8 md:p-12 text-center">
                ...
                <Link to="/contact">
                  <Button size="lg" className="electric-button font-tech text-lg px-8 py-6">
      ...
      <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
        <DialogContent className="max-w-2xl bg-card border-electric-blue/30">
          {selectedProject && <>
              ...
              <div className="mt-4">
                <img src={selectedProject.image} alt={selectedProject.title} className="w-full h-48 object-cover rounded-lg mb-6" />
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedProject.technicalDetails.features.map((feature, i) => <li key={i} className="flex items-center gap-2 text-foreground">
                ...
                <div className="flex flex-wrap gap-2 mt-6 pt-6 border-t border-border">
                  {selectedProject.badges.map((badge, i) => <Badge key={i} className="bg-electric-blue/20 text-electric-blue border-electric-blue/30">
                      {badge}
                    </Badge>)}
                </div>
              </div>
